...
def write(report,d,filename,has_hidden_void,voidnum=None,center_mass=None,bounds=None):
            ...
            for e in ext:
                ...
                if all(inside):
                    ...
                    if args.info:
                        ...
                        write(report,d,filename,has_hidden_void,voidnum=voidnum,center_mass=np.around(r[curr_void].center_mass,3).tolist(),bounds=np.around(r[curr_void].bounds,3).tolist())
                    v.remove(curr_void)
                    if v:
